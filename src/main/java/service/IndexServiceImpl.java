...
public class IndexServiceImpl implements IndexService {
    ...
    public boolean addNewIndex(MultipartFile img, Index index) throws IOException {
        ...
        img.transferTo(new File("/www/server/tomcat/webapps//www/server/tomcat/webapps/CSWebsite/" + index.getImg()));
    ...
    public boolean deleteIndex(Index index) {
        new File("/www/server/tomcat/webapps/CSWebsite/" + indexDao.selectIndexByID(index).getImg()).delete();
